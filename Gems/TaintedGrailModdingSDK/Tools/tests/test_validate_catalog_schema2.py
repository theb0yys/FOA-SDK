...
class CatalogSchema2ValidatorTests(unittest.TestCase):
    ...
    def _write_valid_contract(self) -> None:
        ...
        self._write(
            ...
            "Schemas 1-6 remain load-only migration inputs\n"
        ...
        self._write(
            ...
            "successful bound replacement followed by `BuildDocument` produces a schema-7 document\n"
            "## Catalog record\n",
        )
        self._write(
        ...
        self._write(
            ...
            "Catalog saves write explicit schema 7\nLegacy O3DE catalog envelopes\n"
            "loaded candidate remains schema 1\n"
