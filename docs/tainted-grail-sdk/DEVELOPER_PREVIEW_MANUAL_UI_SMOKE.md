...
Evidence binds to the **exact source commit** under review. Historical contracts required **All eight TG SDK panes**, **All nine TG SDK panes**, **All ten TG SDK panes**, **All eleven TG SDK panes**, **All twelve TG SDK panes**, **All thirteen TG SDK panes**, **All fourteen TG SDK panes**, and **All fifteen TG SDK panes** as earlier slices landed. Slice 15 requires **All sixteen TG SDK panes**. Slice 16 requires **All seventeen TG SDK panes**.
...
The normal fixture has no adapter declaration, runtime-result envelope, package-preview input, staging/deployment-preview input, deployment confirmation/work-order input, or deployment execution-result envelope, so it has no post-deployment report. Expected defaults are:
...
Confirm every pane opens and remains interactive. **All seventeen TG SDK panes** must be present.
...
python Gems/TaintedGrailModdingSDK/Tools/developer_preview_ui_evidence.py record `
  ...
  --status pass `
  --notes "All seventeen TG SDK panes opened from the Tools menu."
```
