...
Integration: retain incoming main changes, all 34 pane registrations and CI dependency fixes. ExternalToolchain M2 remains default-disabled; this task does not authorize an M3 transition or game launch through that service.
