...
"""Native LightData buffer transfer test; no game lighting parity claim."""
import hashlib
import json
import os
...
root=Path(os.environ['FOA_LIGHT_DATA_DRAW_ROOT']).resolve(strict=True)
...
def run():
    ...
    general.set_viewport_expansion_policy('FixedSize');general.set_viewport_size(1280,1600);yield 2
    ...
    for case in fixture['cases']:
        ...
        assert stats['read_only_buffer_payload_bytes']==case['record_count']*224*2
        assert stats['constant_payload_bytes']==0
