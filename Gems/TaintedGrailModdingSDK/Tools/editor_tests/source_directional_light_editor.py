...
"""Native directional-light buffer transfer test; no game lighting parity claim."""
import hashlib
import json
import os
...
root=Path(os.environ['FOA_DIRECTIONAL_DRAW_ROOT']).resolve(strict=True)
...
def run():
    ...
    for case in fixture['cases']:
        ...
        assert stats['read_only_buffer_payload_bytes']==case['rows']*176
        assert stats['constant_payload_bytes']==case['rows']*176
