...
namespace TaintedGrailModdingSDK
{
    ...
    // Schemas 1-6 remain load-only migration inputs. New documents use schema 7;
    ...
    inline constexpr AZ::u32 QuestCatalogSchemaVersion = 6;
    inline constexpr AZ::u32 AssetLocalisationCatalogSchemaVersion = 7;
