...
{
    class AdapterPostDeploymentVerifierWidget final
        : public QWidget
        , private FoundationNotificationBus::Handler
    {
    public:
        explicit AdapterPostDeploymentVerifierWidget(QWidget* parent = nullptr);
        ~AdapterPostDeploymentVerifierWidget() override;
